...
if (townName ==="Preston Idaho") {
    var apiURLstring = "https://api.openweathermap.org/data/2.5/forecast?id=5604473&units=imperial&APPID=93f326df890de32f33a0b6e6a3a45ee9"; }
        ...
        var apiURLstring = "https://api.openweathermap.org/data/2.5/forecast?id=5585010&units=imperial&APPID=93f326df890de32f33a0b6e6a3a45ee9";
    }
    
    else if (townName === "Soda Springs Idaho") {
        var apiURLstring = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&units=imperial&APPID=93f326df890de32f33a0b6e6a3a45ee9";
    }
